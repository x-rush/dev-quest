...
│   │   ├── 02-coroutines-guide.md      # 协程速查指南
│   │   ├── 03-flows-channels.md        # Flow和Channel速查
│   │   └── 04-kotlin-idioms.md          # Kotlin惯用语法
│   ├── compose-concepts/                # Compose核心概念
│   │   ├── 01-compose-keywords.md      # Compose关键字详解
│   │   ├── 02-state-management.md      # 状态管理速查
│   │   ├── 03-animation-apis.md        # 动画API速查
│   │   └── 04-navigation-patterns.md    # 导航模式速查
│   ├── android-apis/                   # Android API速查
│   │   ├── 01-jetpack-apis.md          # Jetpack API速查
│   │   ├── 02-lifecycle-apis.md        # 生命周期API速查
│   │   ├── 03-viewmodel-apis.md        # ViewModel API速查
│   │   └── 04-room-apis.md             # Room API速查
│   └── development-tools/               # 开发工具速查
│       ├── 01-android-studio.md       # Android Studio速查
│       ├── 02-gradle-config.md         # Gradle配置速查
