...
| 字典 | [reference/](reference/) | 全量参考，任意跳入（20 篇） | 关键字 / 内置函数 / 数据结构 / OOP 协议 / 类型注解 / 装饰器 / 生成器与迭代器 / 上下文管理器 / asyncio / 异常体系 / 模块与导入 / 字符串格式化 · FastAPI / Django&Flask / uv · 标准库 / 生态库 / pytest · 语法速查 / 故障排除 |
