...
def main() -> None:
    ...
    data = {
        "scope": "Nine explicitly marked, complete examples: PHP and Java keyword, built-in/API, standard-library, Java first-program, enum-semantics, and interface-semantics pages. Excludes existing control-flow evidence and all unmarked partial snippets.",
