...
def main() -> None:
    ...
    report = {
        ...
        "purpose": "Twenty-fifth-round runtime evidence for fourteen marked Go core-document fences.",
        ...
        "scope": "Only the fourteen named complete Go fences extracted unchanged after CRLF-to-LF normalization were executed. Other fences, toolchain setup, web services, filesystem integrations, concurrency scheduling, performance, and projects remain outside this evidence.",
    ...
    lines = ["# Go 核心基础页第二十五批运行验证", "", "仅运行下列十四个正文中有 `doc-verify` 标记的完整 Go 围栏。报告不将结果扩大为整页、工具链或项目验证。", "", "| 文档 | 示例 | 结果 |", "|---|---|---|"]
